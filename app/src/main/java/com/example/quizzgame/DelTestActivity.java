...
public class DelTestActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_del_test);
        EditText editText = findViewById(R.id.name_testdel);
        Button btn = findViewById(R.id.btn_deletetest);
    ...
    public void removeSingleNode(String nameNode) {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("list_test/"+nameNode);
